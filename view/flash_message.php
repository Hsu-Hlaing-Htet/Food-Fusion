...
function display_flash_message()
{
    if (isset($_SESSION['flash'])) {
        ...
        if (isset($styles[$type])) {
            ...
            echo '<div class="flash-message w-auto fixed top-4 bg-white right-4 animate-fade-in-up transition-all duration-300 border-l-4 border-' . $color . '-500 bg-' . $color . '-50 p-4 shadow-lg rounded-lg z-50">
